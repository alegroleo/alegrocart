...
var datePickerController = (function datePickerController() {
    ...
    function datePicker(options) {
        ...
        this.reposition = function() {
            ...
            var osh         = o.div.offsetHeight,
                ...
                bodyTag     = trueBody.getElementsByTagName('body')[0],
                bodyTagWidth= bodyTag.offsetWidth;

            o.div.style.visibility = "visible";

            o.div.style.left = Number(parseInt(bodyTagWidth+scrollLeft) < parseInt(osw+pos[0]) ? pos[0] - osw + 18 : pos[0]) + "px";
            o.div.style.top  = (bSpace > tSpace) ? Math.abs(parseInt(pos[1] + elem.offsetHeight + 10)) + "px" : Math.abs(parseInt(pos[1] - (osh + 10))) + "px";
            if(oldIE === 6) {
	...
	var noLeadingZero = +elem.options[opt].value;
            if(noLeadingZero == indx) {
