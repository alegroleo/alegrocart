...
$_['text_tpl_column']		= 'The left column is always included with either 2 or 3 column layout.<br>The Category Menu must be included in this column.<br>Default Modules: cart, category, manufacturer, popular, review, information.<br>If layout is 2 column, search options or category options will be included.';
