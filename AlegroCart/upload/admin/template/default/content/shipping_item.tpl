...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
  ...
  <input type="hidden" name="global_item_status" value="">
  <input type="hidden" name="global_item_geo_zone_id" value="">
  <input type="hidden" name="global_item_max" value="">
  <input type="hidden" name="global_item_sort_order" value="">
  <input type="hidden" name="global_item_cost" value="">
  <input type="hidden" name="global_item_tax_class_id" value="">
</form>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  <script type="text/javascript"><!--
	function getValues() {
		document.forms['update_form'].global_item_status.value=document.forms['form'].global_item_status.value;
		document.forms['update_form'].global_item_cost.value=document.forms['form'].global_item_cost.value;
		document.forms['update_form'].global_item_geo_zone_id.value=document.forms['form'].global_item_geo_zone_id.value;
		document.forms['update_form'].global_item_max.value=document.forms['form'].global_item_max.value;
		document.forms['update_form'].global_item_tax_class_id.value=document.forms['form'].global_item_tax_class_id.value;
		document.forms['update_form'].global_item_sort_order.value=document.forms['form'].global_item_sort_order.value;
	}
  //--></script>
  <script type="text/javascript"><!--
  $(document).ready(function() {
$('.task').each(function(){
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=shipping_item&action=help',
		async:   false,
