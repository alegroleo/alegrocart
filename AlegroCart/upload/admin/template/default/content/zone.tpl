<div class="task">
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
   ...
   <input type="hidden" name="zone_status" value="">
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  <script type="text/javascript"><!--
	function getValues() {
		...
		document.forms['update_form'].zone_status.value=document.forms['form'].zone_status.value;
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=zone&action=help',
		async:   false,
