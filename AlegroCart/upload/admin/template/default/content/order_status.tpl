...
<div class="task">
  ...
  <input type="hidden" name="language[<?php echo $order_status['language_id']; ?>][name]" value="">
  <?php } ?>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=order_status&action=help',
		async:   false,
  ...
  <script type="text/javascript"><!--
	...
	$.ajax({
		type:	'POST',
		url:	'index.php?controller=order_status&action=tab',
		data: data_json,
		dataType:'json'
	});
	});
	function getValues() {
		<?php foreach ($order_statuses as $order_status) { ?>
			document.forms['update_form'].elements['language[<?php echo $order_status['language_id']; ?>][name]'].value=document.forms['form'].elements['language[<?php echo $order_status['language_id']; ?>][name]'].value;
		<?php } ?>
	}
  //--></script>
  <script type="text/javascript"><!--
