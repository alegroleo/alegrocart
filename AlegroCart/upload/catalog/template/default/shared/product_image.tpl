<?php if($image_display == 'thickbox'){?>
  ...
  <img src="<?php echo $product['thumb'];?>" id="<?php echo $this_controller.'_image'.$product['product_id']; ?>" title="<?php echo $product['name']; ?>" width="<?php echo $product['image_width']; ?>" height="<?php echo $product['image_height']; ?>" alt="<?php echo $product['name']; ?>"></a>
...
<img src="<?php echo $product['thumb'];?>" id="<?php echo $this_controller.'_image'.$product['product_id']; ?>" title="<?php echo $product['name']; ?>" width="<?php echo $product['image_width']; ?>" height="<?php echo $product['image_height']; ?>" alt="<?php echo $product['name']; ?>"></a><div class="enlarge"><a href="<?php echo $product['popup']; ?>" id="<?php echo $this_controller.'_enlarge'.$product['product_id']; ?>"><?php echo $text_enlarge; ?></a></div></a>
...
<img src="<?php echo $product['thumb'];?>" id="<?php echo $this_controller.'_image'.$product['product_id']; ?>" title="<?php echo $product['name']; ?>" width="<?php echo $product['image_width']; ?>" height="<?php echo $product['image_height']; ?>" alt="<?php echo $product['name']; ?>"></a><div class="enlarge"><a class="lightbox" id="<?php echo $this_controller.'_enlarge'.$product['product_id']; ?>" href="<?php echo $product['popup']; ?>"><?php echo $text_enlarge; ?></a></div></a>
<?php } ?>
