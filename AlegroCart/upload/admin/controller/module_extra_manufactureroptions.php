...
class ControllerModuleExtraManufactureroptions extends Controller {
	...
	function __construct(&$locator){
		...
		$this->adminController = $this->template->set_controller('module_extra_manufactureroptions');
	...
	function index() { 
		...
		if (($this->request->isPost()) && ($this->validate())) {
			...
			if ($this->request->has('update_form', 'post')) {
				$this->response->redirect($this->url->ssl('module_extra_manufactureroptions'));
			} else {
		...
		$this->session->set('last_module', 'module_extra_manufactureroptions');
		$this->session->set('last_extension_id', $this->modelManOptions->get_extension_id('module_extra_manufactureroptions'));
	...
	function uninstall() {
		if ($this->user->hasPermission('modify', 'module_extra_manufactureroptions')) {
			$this->modelManOptions->delete_manufacturer_options();
			if ($this->session->get('last_module') == 'module_extra_manufactureroptions') {
