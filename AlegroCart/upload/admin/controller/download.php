...
class ControllerDownload extends Controller {
	...
	public $error = array();
	private $prohibited_types = array('php');
	...
	private function getDownloadName($file) {
		$str=$file;
	...
	private function get_uploadable(){
