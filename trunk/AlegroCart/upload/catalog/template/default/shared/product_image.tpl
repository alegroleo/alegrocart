...
<script type="text/javascript">$(document).ready(function(){$("a#<?php echo $this_controller.$product['product_id']; ?>, a#<?php echo $this_controller.'_enlarge'.$product['product_id']; ?>").fancybox({openEffect : 'elastic', closeEffect : 'elastic'}); });</script>
