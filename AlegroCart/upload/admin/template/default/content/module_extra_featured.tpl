...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
  ...
  <input type="hidden" name="catalog_featured_status" value="">
  <input type="hidden" name="catalog_featured_image_height" value="">
  <input type="hidden" name="catalog_featured_image_width" value="">
  <input type="hidden" name="catalog_featured_image_display" value="">
  <input type="hidden" name="catalog_featured_ratings" value="">
  <input type="hidden" name="catalog_featured_addtocart" value="">
  <input type="hidden" name="catalog_featured_lines_single" value="">
  <input type="hidden" name="catalog_featured_lines_multi" value="">
  <input type="hidden" name="catalog_featured_lines_char" value="">
  <input type="hidden" name="catalog_featured_slider" value="">
  <input type="hidden" name="catalog_featured_scolumns" value="">
  <input type="hidden" name="catalog_featured_slimit" value="">
  <input type="hidden" name="catalog_featured_columns" value="">
  <input type="hidden" name="catalog_featured_limit" value="">
</form>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
    ...
    <div class="pages">
      <div class="page">
		...
		<tr>
              ...
              <td><select name="catalog_featured_ratings">
                  <?php if ($catalog_featured_ratings) { ?>
                  <option value="1" selected><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
  ...
  <script type="text/javascript"><!--
	function getValues() {
		document.forms['update_form'].catalog_featured_status.value=document.forms['form'].catalog_featured_status.value;
		document.forms['update_form'].catalog_featured_image_width.value=document.forms['form'].catalog_featured_image_width.value;
		document.forms['update_form'].catalog_featured_image_height.value=document.forms['form'].catalog_featured_image_height.value;
		document.forms['update_form'].catalog_featured_image_display.value=document.forms['form'].catalog_featured_image_display.value;
		document.forms['update_form'].catalog_featured_ratings.value=document.forms['form'].catalog_featured_ratings.value;
		document.forms['update_form'].catalog_featured_addtocart.value=document.forms['form'].catalog_featured_addtocart.value;
		document.forms['update_form'].catalog_featured_lines_single.value=document.forms['form'].catalog_featured_lines_single.value;
		document.forms['update_form'].catalog_featured_lines_multi.value=document.forms['form'].catalog_featured_lines_multi.value;
		document.forms['update_form'].catalog_featured_lines_char.value=document.forms['form'].catalog_featured_lines_char.value;
		document.forms['update_form'].catalog_featured_slider.value=document.forms['form'].catalog_featured_slider.value;
		document.forms['update_form'].catalog_featured_scolumns.value=document.forms['form'].catalog_featured_scolumns.value;
		document.forms['update_form'].catalog_featured_slimit.value=document.forms['form'].catalog_featured_slimit.value;
		document.forms['update_form'].catalog_featured_columns.value=document.forms['form'].catalog_featured_columns.value;
		document.forms['update_form'].catalog_featured_limit.value=document.forms['form'].catalog_featured_limit.value;
	}
  //--></script>
  <script type="text/javascript"><!--
  $(document).ready(function() {
$('.task').each(function(){
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=module_extra_featured&action=help',
		async:   false,
