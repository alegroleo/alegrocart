...
$_['error_php']            = 'PHP 5.4 ou supérieur est nécessaire pour AlegroCart';
$_['error_session']        = 'Vous devez désactiver "session.auto_start" dans php.ini pour utiliser AlegroCart';
$_['error_mysqli']         = 'L\'extension MySqli est requise pour faire fonctionner AlegroCart';
...
$_['error_admin_passw_lenght'] = 'Le mot de passe doit comprendre entre 6 et 20 caractères!';
...
$_['robots']               = 'Rendez \'robots.txt\' non-inscriptible (chmod go-w 644).';
