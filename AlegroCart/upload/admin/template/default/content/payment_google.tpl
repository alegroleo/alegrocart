...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
  ...
  <input type="hidden" name="global_google_status" value="">
  <input type="hidden" name="global_google_geo_zone_id" value="">
  <input type="hidden" name="global_google_merchantid" value="">
  <input type="hidden" name="global_google_merchantkey" value="">
  <input type="hidden" name="global_google_test" value="">
  <input type="hidden" name="global_google_currency" value="">
  <input type="hidden" name="global_google_sort_order" value="">
</form>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  <script type="text/javascript"><!--
	function getValues() {
		document.forms['update_form'].global_google_status.value=document.forms['form'].global_google_status.value;
		document.forms['update_form'].global_google_geo_zone_id.value=document.forms['form'].global_google_geo_zone_id.value;
		document.forms['update_form'].global_google_merchantid.value=document.forms['form'].global_google_merchantid.value;
		document.forms['update_form'].global_google_merchantkey.value=document.forms['form'].global_google_merchantkey.value;
		document.forms['update_form'].global_google_test.value=document.forms['form'].global_google_test.value;
		document.forms['update_form'].global_google_currency.value=document.forms['form'].global_google_currency.value;
		document.forms['update_form'].global_google_sort_order.value=document.forms['form'].global_google_sort_order.value;
	}
  //--></script>
  <script type="text/javascript"><!--
  $(document).ready(function() {
$('.task').each(function(){
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=payment_google&action=help',
		async:   false,
