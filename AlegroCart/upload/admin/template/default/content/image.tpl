    ...
    <div class="pages">
      ...
      <div class="page">
		...
		<div class="file_input_div">
			...
			<input type="file" name="image" id="image" class="file_input_hidden" onchange="javascript: document.getElementById('fileName').value = this.value" />
			<label for="image"><?php echo $text_browse; ?></label>
		</div>
                <?php if ($error_file) { ?>
		  ...
		  <?php if(isset($image_data)){?>
			<table>
			  <tr>
				...
				<td id="image"><img src="<?php echo $image_data[0]['thumb'];?>" width="<?php echo $image_data[0]['width'];?>" height="<?php echo $image_data[0]['height'];?>" alt="<?php echo $image_data[0]['filename']; ?>" ></td>
			  </tr>
			</table>
		  <?php }?>
        </div>
