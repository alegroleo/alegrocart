        ...
        <div class="pad">
          <table>
			...
			<tr>
              ...
              <td><input type="text" name="catalog_specials_lines_single" value="<?php echo $catalog_specials_lines_single; ?>" size="1" /></td>
            </tr>
			<tr>
              <td class="set"><?php echo $entry_lines_multi; ?></td>
              <td><input type="text" name="catalog_specials_lines_multi" value="<?php echo $catalog_specials_lines_multi; ?>" size="1" /></td>
            </tr>
			<tr>
              <td class="set"><?php echo $entry_lines_char; ?></td>
              <td><input type="text" name="catalog_specials_lines_char" value="<?php echo $catalog_specials_lines_char; ?>" size="3" /></td>
            </tr>
          </table>
		  <table>
