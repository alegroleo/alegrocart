...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
  ...
  <input type="hidden" name="global_moneyorder_status" value="">
  <input type="hidden" name="global_moneyorder_geo_zone_id" value="">
  <input type="hidden" name="global_moneyorder_sort_order" value="">
</form>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  <script type="text/javascript">
	function getValues() {
		document.forms['update_form'].global_moneyorder_status.value=document.forms['form'].global_moneyorder_status.value;
		document.forms['update_form'].global_moneyorder_geo_zone_id.value=document.forms['form'].global_moneyorder_geo_zone_id.value;
		document.forms['update_form'].global_moneyorder_sort_order.value=document.forms['form'].global_moneyorder_sort_order.value;
	}
  </script>
  <script type="text/javascript">
...
$('.task').each(function(){
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=payment_moneyorder&action=help',
		async:   false,
