<?php if (count($manufacturers_data) > 1){?>
 <table>
  ...
  <tr><td>
   <select id="manufacturer_option" name="manufacturer" style="width: 180px;" onchange="$('#model').load('index.php?controller=<?php echo $this_controller;?>&amp;action=model&amp;manufacturer='+this.value);">
