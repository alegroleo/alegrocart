...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
  ...
  <input type="hidden" name="catalog_categoryslider_status" value="">
  <input type="hidden" name="catalog_categoryslider_image_width" value="">
  <input type="hidden" name="catalog_categoryslider_image_height" value="">
</form>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  <script type="text/javascript">
	function getValues() {
		document.forms['update_form'].catalog_categoryslider_status.value=document.forms['form'].catalog_categoryslider_status.value;
		document.forms['update_form'].catalog_categoryslider_image_width.value=document.forms['form'].catalog_categoryslider_image_width.value;
		document.forms['update_form'].catalog_categoryslider_image_height.value=document.forms['form'].catalog_categoryslider_image_height.value;
	}
  </script>
  <script type="text/javascript">
...
$('.task').each(function(){
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=module_extra_categoryslider&action=help',
		async:   false,
