...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
  ...
  <input type="hidden" name="catalog_search_options_status" value="">
  <input type="hidden" name="catalog_search_columns" value="">
  <input type="hidden" name="catalog_search_display_lock" value="">
</form>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  <script type="text/javascript"><!--
	function getValues() {
		document.forms['update_form'].catalog_search_options_status.value=document.forms['form'].catalog_search_options_status.value;
		document.forms['update_form'].catalog_search_columns.value=document.forms['form'].catalog_search_columns.value;
		document.forms['update_form'].catalog_search_display_lock.value=document.forms['form'].catalog_search_display_lock.value;
	}
  //--></script>
  <script type="text/javascript"><!--
...
$('.task').each(function(){
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=module_extra_searchoptions&action=help',
		async:   false,
