...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
  ...
  <input type="hidden" name="catalog_category_status" value="">
  <input type="hidden" name="catalog_category_mcount" value="">
  <input type="hidden" name="catalog_category_pcount" value="">
  <input type="hidden" name="catalog_category_ratings" value="">
</form>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  <script type="text/javascript">
	function getValues() {
		document.forms['update_form'].catalog_category_status.value=document.forms['form'].catalog_category_status.value;
		document.forms['update_form'].catalog_category_mcount.value=document.forms['form'].catalog_category_mcount.value;
		document.forms['update_form'].catalog_category_pcount.value=document.forms['form'].catalog_category_pcount.value;
		document.forms['update_form'].catalog_category_ratings.value=document.forms['form'].catalog_category_ratings.value;
	}
  </script>
  <script type="text/javascript">
...
$('.task').each(function(){
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=module_catalog_category&action=help',
		async:   false,
