...
class ControllerModuleExtraManufacturer extends Controller {
	...
	function __construct(&$locator){
		...
		$this->adminController = $this->template->set_controller('module_extra_manufacturer');
	...
	function index() { 
		...
		if (($this->request->isPost()) && ($this->validate())) {
			...
			if ($this->request->has('update_form', 'post')) {
				$this->response->redirect($this->url->ssl('module_extra_manufacturer'));
			} else {
		...
		$this->session->set('last_module', 'module_extra_manufacturer');
		$this->session->set('last_extension_id', $this->modelManufacturer->get_extension_id('module_extra_manufacturer'));
	...
	function uninstall() {
		if ($this->user->hasPermission('modify', 'module_extra_manufacturer')) {
			$this->modelManufacturer->delete_manufacturer();
			if ($this->session->get('last_module') == 'module_extra_manufacturer') {
