...
(function($) {
   ...
   function end() {
	...
	$.fn.lightbox.defaults = {
		allSet: false,
		fileLoadingImage: 'catalog/javascript/lightbox/image/loading.gif',
		fileBottomNavCloseImage: 'catalog/javascript/lightbox/image/closelabel.gif',
		overlayOpacity: 0.8,
		borderSize: 10,
