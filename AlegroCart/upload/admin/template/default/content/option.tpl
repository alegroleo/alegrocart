...
<div class="task">
  ...
  <input type="hidden" name="language[<?php echo $option['language_id']; ?>][name]" value="">
  <?php } ?>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=option&action=help',
		async:   false,
  ...
  <script type="text/javascript"><!--
	...
	$.ajax({
		type:	'POST',
		url:	'index.php?controller=option&action=tab',
		data: data_json,
		dataType:'json'
	});
	});
	function getValues() {
		<?php foreach ($options as $option) { ?>
			document.forms['update_form'].elements['language[<?php echo $option['language_id']; ?>][name]'].value=document.forms['form'].elements['language[<?php echo $option['language_id']; ?>][name]'].value;
		<?php } ?>
	}
  //--></script>
  <script type="text/javascript"><!--
