...
class Model_Admin_Setting extends Model {
	...
	function update_setting(){
		...
		$this->database->query("insert into setting set type = 'global', `group` = 'config', `key` = 'config_stamp', `value` = '" . $this->request->gethtml('global_config_stamp', 'post') . "'");
		...
		$this->database->query("insert into setting set type = 'admin', `group` = 'config', `key` = 'config_admin_page_load', `value` = '" . $this->request->gethtml('admin_config_admin_page_load', 'post') . "'");
