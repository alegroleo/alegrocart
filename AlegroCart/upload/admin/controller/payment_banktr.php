...
class ControllerPaymentbanktr extends Controller {
	...
	function __construct(&$locator){
		...
		$this->adminController = $this->template->set_controller('payment_banktr');
	...
	function index() {
		...
		$this->template->set('title', $this->language->get('heading_title'));
			...
			if ($this->request->has('update_form', 'post')) {
				$this->response->redirect($this->url->ssl('payment_banktr'));
			} else {
		...
		$this->session->set('last_payment', 'payment_banktr');
		$this->session->set('last_extension_id', $this->modelBTR->get_extension_id('payment_banktr'));
	...
	function uninstall() {
		if ($this->user->hasPermission('modify', 'payment_banktr')) {
			$this->modelBTR->delete_BTR();
			if ($this->session->get('last_payment') == 'payment_banktr') {
