...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
  ...
  <input type="hidden" name="catalog_homepage_status" value="">
</form>
...
<div class="description"><?php echo $heading_description; ?></div>
  ...
  <script type="text/javascript"><!--
	function getValues() {
		document.forms['update_form'].catalog_homepage_status.value=document.forms['form'].catalog_homepage_status;
	}
  //--></script>
  <script type="text/javascript"><!--
...
$('.task').each(function(){
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=module_extra_homepage&action=help',
		async:   false,
