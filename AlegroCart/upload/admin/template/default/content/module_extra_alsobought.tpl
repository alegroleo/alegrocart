...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
  ...
  <input type="hidden" name="catalog_alsobought_status" value="">
  <input type="hidden" name="catalog_alsobought_total" value="">
  <input type="hidden" name="catalog_alsobought_image_height" value="">
  <input type="hidden" name="catalog_alsobought_image_width" value="">
  <input type="hidden" name="catalog_alsobought_image_display" value="">
  <input type="hidden" name="catalog_alsobought_ratings" value="">
  <input type="hidden" name="catalog_alsobought_addtocart" value="">
  <input type="hidden" name="catalog_alsobought_lines_single" value="">
  <input type="hidden" name="catalog_alsobought_lines_multi" value="">
  <input type="hidden" name="catalog_alsobought_lines_char" value="">
  <input type="hidden" name="catalog_alsobought_slider" value="">
  <input type="hidden" name="catalog_alsobought_scolumns" value="">
  <input type="hidden" name="catalog_alsobought_slimit" value="">
  <input type="hidden" name="catalog_alsobought_columns" value="">
  <input type="hidden" name="catalog_alsobought_limit" value="">
</form>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  <script type="text/javascript"><!--
	function getValues() {
		document.forms['update_form'].catalog_alsobought_status.value=document.forms['form'].catalog_alsobought_status.value;
		document.forms['update_form'].catalog_alsobought_total.value=document.forms['form'].catalog_alsobought_total.value;
		document.forms['update_form'].catalog_alsobought_image_width.value=document.forms['form'].catalog_alsobought_image_width.value;
		document.forms['update_form'].catalog_alsobought_image_height.value=document.forms['form'].catalog_alsobought_image_height.value;
		document.forms['update_form'].catalog_alsobought_image_display.value=document.forms['form'].catalog_alsobought_image_display.value;
		document.forms['update_form'].catalog_alsobought_ratings.value=document.forms['form'].catalog_alsobought_ratings.value;
		document.forms['update_form'].catalog_alsobought_addtocart.value=document.forms['form'].catalog_alsobought_addtocart.value;
		document.forms['update_form'].catalog_alsobought_lines_single.value=document.forms['form'].catalog_alsobought_lines_single.value;
		document.forms['update_form'].catalog_alsobought_lines_multi.value=document.forms['form'].catalog_alsobought_lines_multi.value;
		document.forms['update_form'].catalog_alsobought_lines_char.value=document.forms['form'].catalog_alsobought_lines_char.value;
		document.forms['update_form'].catalog_alsobought_slider.value=document.forms['form'].catalog_alsobought_slider.value;
		document.forms['update_form'].catalog_alsobought_scolumns.value=document.forms['form'].catalog_alsobought_scolumns.value;
		document.forms['update_form'].catalog_alsobought_slimit.value=document.forms['form'].catalog_alsobought_slimit.value;
		document.forms['update_form'].catalog_alsobought_columns.value=document.forms['form'].catalog_alsobought_columns.value;
		document.forms['update_form'].catalog_alsobought_limit.value=document.forms['form'].catalog_alsobought_limit.value;
	}
  //--></script>
  <script type="text/javascript"><!--
...
$('.task').each(function(){
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=module_extra_alsobought&action=help',
		async:   false,
