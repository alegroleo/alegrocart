...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
  ...
  <input type="hidden" name="global_subtotal_status" value="">
  <input type="hidden" name="global_subtotal_sort_order" value="">
</form>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  <script type="text/javascript">
	function getValues() {
		document.forms['update_form'].global_subtotal_status.value=document.forms['form'].global_subtotal_status.value;
		document.forms['update_form'].global_subtotal_sort_order.value=document.forms['form'].global_subtotal_sort_order.value;
	}
  </script>
  <script type="text/javascript">
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=calculate_subtotal&action=help',
		async:   false,
