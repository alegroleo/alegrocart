<tr id="<?php echo $location . '_' . $module_id; ?>">
  ...
  <td><input class="validate_int" id="<?php echo $location . $module_id; ?>sort_order" type="text" name= "<?php echo $location . '[' .  $module_id; ?>][sort_order]" value="" size="2" onfocus="RegisterValidation()"></td>
