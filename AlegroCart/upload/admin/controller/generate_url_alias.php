...
class ControllerGenerateUrlAlias extends Controller {
	...
	private function product_to_review(){
	...
	private function manufacturer_to_product(){
	...
	private function product_to_category(){ 
	...
	private function accounts(){
		...
		$this->generate_seo->_insert_url_alias('controller=bought', $this->language->get('bought_url'));
	}

	private function validate_seo() {
