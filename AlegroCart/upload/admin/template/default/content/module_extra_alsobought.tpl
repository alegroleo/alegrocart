      ...
      <div class="page">
		...
		<td class="expl">
            ...
            <tr>
              ...
              <td><input type="text" name="catalog_alsobought_limit" value="<?php echo $catalog_alsobought_limit; ?>" size="1" /></td>
		<td class="expl">
		...
		<td class="expl">
            ...
            <tr>
              ...
              <td><input type="text" name="catalog_alsobought_total" value="<?php echo $catalog_alsobought_total; ?>" size="3"></td>
		<td class="expl">
			...
			<tr>
			  ...
			  <td><input type="text" name="catalog_alsobought_image_height" value="<?php echo $catalog_alsobought_image_height; ?>" size="3"></td>
		<td class="expl">
			...
			<tr>
			  ...
			  <td><input type="text" name="catalog_alsobought_image_width" value="<?php echo $catalog_alsobought_image_width; ?>" size="3"></td>
		<td class="expl">
		...
		<td class="expl">
          ...
          <tr>
              ...
              <td><input type="text" name="catalog_alsobought_lines_single" value="<?php echo $catalog_alsobought_lines_single; ?>" size="1" /></td>
		<td class="expl">
			...
			<tr>
              ...
              <td><input type="text" name="catalog_alsobought_lines_multi" value="<?php echo $catalog_alsobought_lines_multi; ?>" size="1" /></td>
		<td class="expl">
			...
			<tr>
              ...
              <td><input type="text" name="catalog_alsobought_lines_char" value="<?php echo $catalog_alsobought_lines_char; ?>" size="3" /></td>
		<td class="expl">
