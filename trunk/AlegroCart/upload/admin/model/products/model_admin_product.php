...
class Model_Admin_Product extends Model {
	...
	function insert_product(){
		$sql = "insert into product set quantity = '?', date_available = '?', manufacturer_id = '?', image_id = '?', shipping = '?', price = '?', sort_order = '?', weight = '?', weight_class_id = '?', dimension_id = '?', dimension_value = '?', status = '?', tax_class_id = '?', min_qty = '?', featured = '?', special_offer = '?', related = '?', special_price = '?', sale_start_date = '?', sale_end_date = '?', date_added = now(), date_modified = now()";
	...
	function update_product(){
		$sql = "update product set quantity = '?', date_available = '?', manufacturer_id = '?', image_id = '?', shipping = '?', price = '?', sort_order = '?', weight = '?', weight_class_id = '?', dimension_id = '?', dimension_value = '?', status = '?', tax_class_id = '?', min_qty = '?', featured = '?', special_offer = '?', related = '?', special_price = '?', sale_start_date = '?', sale_end_date = '?', date_modified = now() where product_id = '?'";
