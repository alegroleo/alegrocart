...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="update_form" name="update_form" >
  ...
  <input type="hidden" name="catalog_category_options_status" value="">
  <input type="hidden" name="catalog_category_columns" value="">
  <input type="hidden" name="catalog_category_display_lock" value="">
</form>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
  ...
  <script type="text/javascript"><!--
	function getValues() {
		document.forms['update_form'].catalog_category_options_status.value=document.forms['form'].catalog_category_options_status.value;
		document.forms['update_form'].catalog_category_columns.value=document.forms['form'].catalog_category_columns.value;
		document.forms['update_form'].catalog_category_display_lock.value=document.forms['form'].catalog_category_display_lock.value;
	}
  //--></script>
  <script type="text/javascript"><!--
...
$('.task').each(function(){
  ...
  function ShowDesc(){
	$.ajax({
		type:    'POST',
		url:     'index.php?controller=module_extra_categoryoptions&action=help',
		async:   false,
