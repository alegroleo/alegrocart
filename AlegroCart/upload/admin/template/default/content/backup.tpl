    ...
    <div class="pages">
      <div class="page">
		...
		<div class="file_input_div">
			...
			<input type="file" name="database" id="database" class="file_input_hidden" onchange="javascript: document.getElementById('fileName').value = this.value" />
			<label for="database"><?php echo $text_browse; ?></label>
		</div>
	    </td>
            <td class="expl">
